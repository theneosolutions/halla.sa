...
function Messages() {
  return (
    <Template1>
      <div className="px-3 md:px-20 py-10 flex flex-col md:flex-row md:space-x-20 md:h-screen">
        ...
        <div className="md:w-3/4">
          ...
          <div className="h-5/6 0">
            ...
            <div className="flex flex-row justify-between  items-center h-1/6 my-3 md:my-0">
              <Search
